    ...
    <div class="  h-screen flex justify-center">
      <div class=" m-4 md:m-16 max-w-3xl mb-24 h-auto ">
              ...
              <div class="flex justify-between">
                    ...
                    <div class="mt-2">
                         <a href="./editUser.php" class="bg-blue1 rounded-xl text-white px-4 py-3  border-2 md:text-sm border-white hover:bg-blue2 ">Edytuj </a>
                    </div>
              </div class="">
                <h2 class="font-bold text-xl mb-2 md:text-left">Podstawowe informacje</h2>  
