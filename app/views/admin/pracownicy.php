  ...
  <div class="flex w-full">
    ...
    <div class="p-4 mt-4 w-full">
      <div class="flex justify-between w-full">
        <h1 class="text-2xl font-bold mb-4 w-full">Lista Kont Pracowników</h1>
        
        <form action="pracownicy.php" method="get" class="mb-4 flex h-12 w-full">
            ...
            <tbody>
                <?php if (!empty($users) && count($users) > 0): ?>
                    ...
                    <tr>
                        ...
                        <td class="py-3 px-5 border border-slate-600 text-center mx-auto">
